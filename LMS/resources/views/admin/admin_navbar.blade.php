...
<body>
    <nav class="navbar navbar-expand-lg "  style="background-color:green; color: white">
        <div class="container-fluid">
            <a class="navbar-brand"  href="{{route('admin_dashboard')}}" style="color: white">learners</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route('admin_dashboard')}}" style="color: white">Dashboard</a>
                    </li> 
                    <li class="nav-item">
